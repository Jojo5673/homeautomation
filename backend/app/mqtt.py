...
class MQTT:
    ...
    sub_topics = [("620172690_pub", 0), ("620172690", 0), ("620172690_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620172690", self.update)
        self.client.message_callback_add("620172690_pub", self.toggle)
